...
def main():
   ...
   if sys.argv[2] == 'T':
   	   printHeader = True
   for expr in sys.argv[3:len(sys.argv)]:
      for filename in glob.glob(expr):
         ...
         if printHeader:
            print "filename, #contigs, #trimmed contigs, total length, min contig, median contig, mean contig, max contig,\
         N50 contig, N50 length, N90 contig, N90 length"
         print "{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}".format(str(filename), str(statN), str(statTrimmedN),
 		 str(statSum), str(statMin), str(statMed), str(statMean), str(statMax), str(statN50), str(statN50Len),
 		 str(statN90), str(statN90Len))

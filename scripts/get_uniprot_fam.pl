...
my $query = "http://www.uniprot.org/uniprot/?query=$taxon&format=fasta&include=yes";
my $file = $taxon . '.fasta';

my $contact = 'cs.welcher@gmail.com'; # Please set your email address here to help us debug in case of problems.
